...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    <head>
      ...
      <title>Indo Database 45 Index</title>
    ...
    <body>
      <nav id="navbar" data-turbolinks-permanent><div class="brand">Indo Database 45</div></nav>
      ${body}
      <div class="paginate-container">${pagination(pIdx)}</div>
      <div id="flex-container" data-turbolinks-permanent style="flex-grow: 1;"></div>
      <footer id="footer" data-turbolinks-permanent><p>Powered by Indo Database 45</p></footer>
      <script>
